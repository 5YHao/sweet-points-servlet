...
@WebServlet("/selectGetAwardRecordByUserId")
public class selectGetAwardRecordByUserId extends HttpServlet {
...
//        获取SqlSession对象
        ...
        System.out.println("/selectGetAwardRecordByUserId【" + string_date + "】收到user_id:" + user_id);
        //        调用Mapper接口
        List<GetAwardRecord> getAwardRecords = getAwardRecordMapper.selectGetAwardRecordByUserId(user_id);
        System.out.println();

...
//        List<User> users = sqlSession.selectList("sql.selectAllUser");
        ...
        System.out.println("/deleteMission【" + string_date + "】收到mission_id:" + mission_id);
        //        调用Mapper接口
        System.out.println("执行1");
        Integer result1 = getMissionRecordMapper.deleteGetMissionRecordByMissionId(mission_id);
        System.out.println("执行2");
        Integer result2 = missionsMapper.deleteMissionById(mission_id);
